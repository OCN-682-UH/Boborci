...
knitr: 
  opts_chunk:
      fig.path: "../Output/"   
---
Questions for Callie: Won't render photos on html if I have them in a fig path
Why won't the message under me cleaning my data go away
...
# But also do I want to change this figure to a point plot with CCA across sites and Algae across sites and then just use the table as supplement for my nitrogen claim
